...
def _find_chrome_win():
    ...
    reg_path_ = [r'SOFTWARE\Microsoft\Windows\CurrentVersion\App Paths\chrome.exe',
     ...
     r'SOFTWARE\Microsoft\Windows\CurrentVersion\App Paths\mozilla.exe']
    chrome_path = None

    for install_type in reg.HKEY_CURRENT_USER, reg.HKEY_LOCAL_MACHINE:
        for reg_path in reg_path_:
            try:
