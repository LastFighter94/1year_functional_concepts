...
class User {
  ...
  public function __construct($name, $email, $password) {
    ...
    // echo 'CONSTRUCTOR RUNS!'; // each time
    // we create a class - onstructors runs
  ...
  function __destruct() {
    echo "<br>The user name testtesttesttest is $this->name.  ";
  }
}
...
// echo $user1->name; // cannot access private property
echo $user1->email; // cannot access private property
echo '<br><br>';
echo $user1->getName();
// echo '<br><br>';
// echo $user1->__destruct();
echo '<br><br>';
echo $user1->login();
echo '<br><br>';
